...
== 转载自 <https://yang-xijie.github.io/WEBSITE/help/>，因为原文介绍的已经足够详细，所以仅修改了我的链接 ==
...
最开始打开网站，也就是通过链接 <https://wongkahome.github.io/>（我的链接） 访问时，会先打开 `/docs/index.md`，这时访问者点击左上角按钮展开目录会先看到大的分类。
